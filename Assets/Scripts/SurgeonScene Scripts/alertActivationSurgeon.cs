...
public class alertActivationSurgeon : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        emergency.OnClick.AddListener(() => StartCoroutine(emergencyActivation(emergency.IsToggled)));
        general.OnClick.AddListener(() => StartCoroutine(generalActiviation(general.IsToggled)));
    }

    private IEnumerator emergencyActivation(bool placeHolder)
    {
    ...
    private IEnumerator generalActiviation(bool placeHolder)
    {
